...
urlpatterns = [
    ...
    path('users/read/<int:page>/', adminapp.UserListView.as_view(), name='pg_users'),
    ...
    path('products/read/category/<int:pk>/', adminapp.ProductsAdminView.as_view(), name='products'),
    path('products/read/<int:pk>/', adminapp.ProductReadAdminView.as_view(), name='product_read'),
    path('products/update/<int:pk>/', adminapp.ProductUpdateAdminView.as_view(), name='product_update'),
    path('products/delete/<int:pk>/', adminapp.ProductDeleteAdminView.as_view(), name='product_delete'),
]
